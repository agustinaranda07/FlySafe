  ...
  return (
    <footer>
      ...
      <div className='title' style={{paddingBottom:"20px"}}>
        ...
        <p className='slogan'>Conoce el mundo entero, conoce FlySafe</p>
      </div>

      <div className='rights-social' style={{borderTop:"1px solid white",paddingTop:"20px"}}>
          <li style={{display:"inline"}}><a href='/'><i class="bi bi-instagram"></i></a></li>
          <li style={{display:"inline"}}><a href='/'><i class="bi bi-twitter"></i></a></li>
          <li style={{display:"inline"}}><a href='/'><i class="bi bi-whatsapp"></i></a></li>
